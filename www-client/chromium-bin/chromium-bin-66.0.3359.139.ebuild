...
MY_VERSION="66.0.3359.139"
#MY_PATCH="$(get_version_component_range 5)"
#MY_PATCH=1215
MY_UBUNTUVERS=18.04.3
KEYWORDS="~arm"

SRC_URI="https://launchpad.net/~chromium-team/+archive/ubuntu/stable/+build/14825335/+files/chromium-browser_${MY_VERSION}-0ubuntu0.${MY_UBUNTUVERS}_armhf.deb
	https://launchpad.net/~chromium-team/+archive/ubuntu/stable/+build/14825335/+files/chromium-codecs-ffmpeg_${MY_VERSION}-0ubuntu0.${MY_UBUNTUVERS}_armhf.deb"
