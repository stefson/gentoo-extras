...
src_prepare() {
	...
	if use system-icu && has_version ">=dev-libs/icu-78.1" ; then
		eapply "${FILESDIR}/firefox-140.7.1-icu78.patch" # bgo#967261
	fi

	eapply "${FILESDIR}/"0001-remove-old-libstdc++-workaround-in-icu-gcc-12-fix.patch
	eapply "${FILESDIR}/"0002-add-arm-to-list-of-mozinline.patch
	eapply "${FILESDIR}/"0003-fix-llvm-22.patch
	eapply "${FILESDIR}/"0004-fix-missing-neckoparent-include.patch
	...
	eapply "${FILESDIR}"/privacy-patchset-140/firefox-140-remove_addons.patch
	...
	rm -rv browser/extensions/{formautofill,newtab,pictureinpicture,webcompat}
