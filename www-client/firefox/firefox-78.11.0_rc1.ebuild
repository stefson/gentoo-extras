...
src_prepare() {
	...
	rm -v "${WORKDIR}"/firefox-patches/0040-bmo-1680166-Return-EFAULT-when-given-a-null-path-to-.patch
	rm -v "${WORKDIR}"/firefox-patches/0041-bmo-1680166-GCC-is-smarter-than-clang-so-ignore-the-.patch
