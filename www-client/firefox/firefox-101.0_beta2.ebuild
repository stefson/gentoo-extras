...
src_prepare() {
	rm -v "${WORKDIR}"/firefox-patches/0027-bmo-1663844-OpenH264-Allow-using-OpenH264-GMP-decode.patch
	rm -v "${WORKDIR}"/firefox-patches/0031-bmo-1762050-fix-pgo-with-virtualenv.patch
