...
src_prepare() {
	...
	eapply "${FILESDIR}"/old/firefox-52.1.0-disable-reader.patch
	eapply "${FILESDIR}"/old/firefox-52.0.2-remove-pocket-leftovers.patch
	eapply "${FILESDIR}"/old/firefox-52.0.2-disable-location.services.patch 
	eapply "${FILESDIR}"/old/firefox-52.1.0-disable-telemetry-options.patch
	
	#arm porting
	eapply "${FILESDIR}"/old/firefox-52.3.0-fix-SandboxEarlyInit-on-arm.patch

	#rust porting
	eapply "${FILESDIR}"/old/firefox-52.8.0-fix-cheddar-for-rust.patch
