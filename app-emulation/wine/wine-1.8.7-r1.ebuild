...
#		 https://bugs.winehq.org/show_bug.cgi?id=18490
		"${FILESDIR}"/${PN}-1.7.39-setpixelformat.patch

#		 https://bugs.winehq.org/show_bug.cgi?id=39403 
#		 this is a hack, 0001-ntdll-Implement FileIoCompletionNotificationInformat.patch should be better 
#		"${FILESDIR}"/${PN}-1.7.55-no-sandbox-for-chromium.patch 

#		 https://bugs.winehq.org/show_bug.cgi?id=36059
		"${FILESDIR}"/0001-setupapi-Implement-SP_COPY_IN_USE_NEEDS_REBOOT.patch

#		 https://bugs.winehq.org/show_bug.cgi?id=38960
		"${FILESDIR}"/0001-ntdll-Implement-FileIoCompletionNotificationInformat.patch 
