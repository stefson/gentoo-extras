...
IUSE="clippy cpu_flags_arm_neon cpu_flags_arm_thumb2 cpu_flags_x86_sse2 debug dist doc miri nightly parallel-compiler rustfmt +system-bootstrap system-llvm test verify-sig wasm ${ALL_LLVM_TARGETS[*]}"
...
LLVM_DEPEND="
	|| (
		sys-devel/llvm:15[${LLVM_TARGET_USEDEPS// /,}]
	)
	<sys-devel/llvm-16:=
"
LLVM_MAX_SLOT=15
...
PATCHES=(
	...
	# 0011 is identical to 1.55.0-ignore-broken from gentoo
	...
	#0040 got dropped, as rls is gone
