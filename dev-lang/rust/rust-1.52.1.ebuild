...
IUSE="clippy cpu_flags_arm_neon cpu_flags_arm_thumb2 cpu_flags_x86_sse2 debug doc miri nightly parallel-compiler rls rustfmt +system-bootstrap system-llvm test verify-sig wasm ${ALL_LLVM_TARGETS[*]}"
...
PATCHES=(
	...
	"${FILESDIR}"/rustc-1.52.1-backport-pr83648.patch
...
#	"${FILESDIR}"/${PV}/0009-test-failed-doctest-output-Fix-normalization.patch
	...
	"${FILESDIR}"/${PV}/0034-libc-linkage.patch
